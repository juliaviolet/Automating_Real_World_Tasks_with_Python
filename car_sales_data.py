...
def process_data(data):
  ...
  for item in data:
    ...
    if item["car"]["car_year"] not in top_car.keys():
      top_car[item["car"]["car_year"]] = item["total_sales"]
    else:
      top_car[item["car"]["car_year"]] += item["total_sales"]

    all_values= top_car.values()
    max_value = max(all_values)
    max_key = max(top_car, key=top_car.get)

  summary = [
    "The {} generated the most revenue: ${}".format(
      format_car(max_revenue["car"]), max_revenue["revenue"]),
    "The {} had the most sales: {}".format(top_sales["car"]["car_model"], top_sales["total_sales"]),
